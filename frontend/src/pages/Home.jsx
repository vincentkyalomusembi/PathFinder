...
export default function Home() {
  ...
  return (
    <div className="space-y-8 pt-20" id="home">
      {" "}
      ...
      <section className="text-center py-20 bg-gradient-to-r from-primary to-secondary text-white">
        <div className="container">
          ...
          <p className="text-xl mb-8">
            I'm a front-end developer passionate about creating amazing user
            experiences.
          </p>
        </div>
      </section>
      <section id="about" className="container">
        ...
        <p className="text-text-secondary">
          Skills: HTML, CSS, JS, React. Experience: 2+ years building responsive
          sites.
        </p>
      </section>
      ...
      <section id="contact" className="container">
        ...
        <form
          action="https://formspree.io/f/xvzzayqv"
          method="POST"
